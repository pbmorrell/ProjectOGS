											...
											<div id="content">
												...
												<section class="box cta">
													<section>
														<h2>SteGiles01</h2>
															<ul class="style3 contact">
																<li class="icon fa-exclamation-circle">
																	<a href="" target="" style="text-decoration:none;">Become a Premium Member</a>
																</li>
																<li class="icon fa-wrench">
																	<a href="" target="" style="text-decoration:none;">Edit Profile</a>
																</li>
																<li class="icon fa-user">
																	<a href="" target="" style="text-decoration:none;">Find Friends</a>
																</li>
																...
																<li class="icon fa-search">
																	<a href="" target="" style="text-decoration:none;">Search Events</a>
																</li>
															</ul>
													</section>
													...
													<li class="icon fa-envelope">
														<a href="" target="" style="text-decoration:none;">Contact Us</a>
													</li>
												</ul>
												</section>
													</section>
