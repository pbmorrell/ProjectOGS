						...
						<div class="12u">
							...
							<!-- Header -->
								<header id="header">
									...
									<!-- Logo -->
										<h1><a href="#" id="logo">Project OGS</a>
										<div id="login">
										<input id="username" type="text" maxlength="50" placeholder=" Username">
										<input id="username" type="text" maxlength="50" placeholder=" Password">
										<button class="button icon fa-sign-in" id="loginbtn">Log In</button>
										</div></h1>
													...
													<div class="row double">
														...
														<section class="6u">
															<header>
																...
																<div id="formexp1">
																	<input id="username" type="text" maxlength="50" placeholder=" Username"><span></span><br/>
																	<input id="username" type="text" maxlength="50" placeholder=" Email Address"><span></span><br/>
																	<input id="username" type="text" maxlength="50" placeholder=" Password"><span></span><br/>
																	<input id="username" type="text" maxlength="50" placeholder=" Confirm Password"><span></span><br/><br/>
																</div>
																
																<button class="button icon fa-cogs" id="signupbtn">Create Free Account</button>
														</section>
